                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown placement="bottom-end">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link 
                            confirm="Logout"
                            confirm-text="Apakah anda yakin akan Log Out?"
                            confirm-button="Ya, saya Log Out!"
                            cancel-button="Tidak, batal Log Out!"
        ...
        <div v-bind:class="{ block: toggled, hidden: !toggled }" class="sm:hidden">
            ...
            <div class="pt-4 pb-1 border-t border-gray-200">
                ...
                <div class="mt-3 space-y-1">
                    <x-responsive-nav-link confirm :href="route('profile.edit')">
                        {{ __('Profile') }}
                    </x-responsive-nav-link>
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <x-responsive-nav-link confirm as="a" :href="route('logout')" onclick="event.preventDefault(); this.closest('form').submit();">
                            {{ __('Log Out') }}
                        </x-responsive-nav-link>
                    </form>
                </div>
